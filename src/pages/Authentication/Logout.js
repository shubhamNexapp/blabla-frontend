...
const Logout = props => {
  ...
  document.title = "logout | InstaOne ";
                  ...
                  <div className="d-flex flex-column h-100">
                    ...
                    <div className="auth-content my-auto">
                      ...
                      <div className="mt-5 text-center">
                        <p className="text-muted mb-0">Don't have an account ? <Link to="/register-number"
                          className="text-primary fw-semibold"> Signup</Link> </p>
                      </div>
                    </div>
                    <div className="mt-4 mt-md-5 text-center">
                      <p className="mb-0">© {new Date().getFullYear()}  InstaOne   .  Powered By Nexapp Technologies Pvt Ltd. <span style={{ color: '#ed8d21' }} >T&C</span></p>
                    </div>
                  </div>
                </div>
              </div>
