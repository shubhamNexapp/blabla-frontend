        ...
        <DndProvider backend={HTML5Backend}>
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Service Partner" breadcrumbItem="All Service Partner" />
                    <Row>
                        <Col xl={12}>
                            <Card>
                                <CardHeader className="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h4 className="card-title">All Service Partner</h4>
                                    </div>
                                    <div>
                                                    ...
                                                    <tr style={{ textAlign: 'center' }} key={row.id}>
                                                        ...
                                                        {columns.map(column => (
                                                            columnsVisibility[column.key] && (
                                                                <td key={column.key}>
                                                                    {column.key === 'id' ? (
                                                                        <Link to={`/admin/edit-service/${row.id}`} state={{ row: row }} className="text-decoration-none">
                                                                            {row[column.key]}
                                                                        </Link>
                                                                    ) : column.key === 'status' ? (
