...
const Index = () => {
    ...
    const [data, setData] = useState([
        ...
        { id: 888, firstName: "Router Installation", assign: "Surej, Pune", username: "+919890453245", status: "Done", date: "21 Jun 2023" },
        { id: 943, firstName: "Router Installation", assign: "Vishal", username: "+919890453245", status: "Done", date: "21 Jun 2023" },
        { id: 323, firstName: "Router Installation", assign: "Vishal", username: "+919890453245", status: "Done", date: "21 Jun 2023" },
        { id: 564, firstName: "Router Installation", assign: "Aditya", username: "+917899453245", status: "Done", date: "21 Jun 2023" },
        { id: 182, firstName: "Router Installation", assign: "Ganesh", username: "+919890453245", status: "Done", date: "21 Jun 2023" },
        { id: 112, firstName: "Router Installation", assign: "Praful", username: "+918890453245", status: "Done", date: "21 Jun 2023" },
        { id: 111, firstName: "Router Installation", assign: "Ganapati", username: "+918890453245", status: "Done", date: "21 Jun 2023" },
        { id: 121, firstName: "Router Installation", assign: "Suraj", username: "+917890453245", status: "Done", date: "21 Jun 2023" },
    ]);
                            ...
                            <Row>
                                <Col xl={12}>
                                    <div className="table-settings" >
                                        <Link to="/add-ticket" className="me-2 btn btn-light"><i className="dripicons-plus"></i></Link>
                                        {/* <Button color="primary" onClick={() => handleRedirect()} className="me-2  btn-light">+</Button> */}
                            ...
                            <CardBody>
                                        ...
                                        <tbody>
                                            {paginatedData.map(row => (
                                                <tr key={row.id}>
                                                    ...
                                                    {columnsVisibility.status && <td><span className={getStatusBadgeClass(row.status)}>{row.status}</span>
                                                    </td>}
                                                    {columnsVisibility.date && <td> {row.date}</td>}
                                                    {columnsVisibility.actions && (
                                                        <td>
                                                            <DropdownComponent rowId={row.id} confirmDelete={confirmDelete} />
                                                        </td>
                                                    )}
                                                </tr>
                                            ))}
                                ...
                                <Pagination aria-label="Page navigation example" className="mt-3">
                                    ...
                                    <Dropdown isOpen={showEntriesDropdownOpen} toggle={toggleShowEntriesDropdown} className="d-inline-block me-2">
                                        <DropdownToggle caret style={{ marginLeft: "20px" }}>
                                            Show Entries
                                        </DropdownToggle>
                                        <DropdownMenu right>
...
const DropdownComponent = ({ rowId, confirmDelete }) => {
    ...
    return (
        <Dropdown className='action' isOpen={dropdownOpen} toggle={toggleDropdown}>
            ...
            <DropdownMenu>
                <DropdownItem onClick={() => console.log('Edit', rowId)}>Edit</DropdownItem>
