...
const TicketPaymentDetails = () => {
  ...
  const dueDate = moment(ticket?.updatedAt)
    .add(30, "days")
    .format("DD-MM-YYYY");
                ...
                <CardBody>
                  <dl className="row mb-0">
                    ...
                    <dd className="col-sm-9">
                      {" "}
                      <b>
                        ₹ {(ticket?.servicePrice * 1.18 + 10).toFixed(2)} :-
                        Service price ({ticket?.servicePrice}) + GST (18%) +
                        Platform fee (10){" "}
                      </b>
                    </dd>
                    ...
                    <dt className="col-sm-3">Payment Due Date:</dt>
                    <dd className="col-sm-9">{dueDate}</dd>

                    <dt className="col-sm-3">Engineers Details:</dt>
                    <dd className="col-sm-9">{ticket?.assign[0]?.name}</dd>
                    ...
                    <dd className="col-sm-9">
                      ...
                      {moment(ticket?.dateRange[0]).format(
                        "DD-MM-YYYY"
                      )} to {moment(ticket?.dateRange[1]).format("DD-MM-YYYY")}
                    </dd>
